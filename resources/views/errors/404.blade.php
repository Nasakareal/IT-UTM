...
<body class="bg-purple">
        ...
        <div class="stars">
            ...
            <div class="central-body">
                <h1 style="color: white; font-size: 120px; margin-top: 20px;">404</h1>
                <h2 style="color: white; margin-top: 10px;">Página no encontrada</h2>
                <p style="color: white; margin-top: 10px; font-size: 18px;">
                    Parece que estás perdido en el espacio
                </p>
                <a href="https://utmorelia.com/IT-UTM/home" class="btn-go-home" target="_blank">Regresa al inicio</a>
            </div>
