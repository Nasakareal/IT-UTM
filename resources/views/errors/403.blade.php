...
.bouncer .eye.left { right: 5px; }
.bouncer .eye.right { right: 30px; }
.bouncer .eye::before {
  content: '';
  position: relative;
  bottom: 8px;
...
.bouncer .body::after {
  ...
  height: 180px;
  background: #38434A;
  border-radius: 15px 42px 100px 10px;
  z-index: 15;
}
.bouncer .arm {
  position: absolute;
...
<body>
    <div style="text-align: center; font-size: 24px; margin-top: 40px; color: #38434A; font-family: 'Arial', sans-serif;">
