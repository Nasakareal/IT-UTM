...
<style>
    ...
    .modal-header.d-flex .modal-title { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; flex-grow: 1; margin-right: .75rem; }
    ...
    .batch-sign { background: #f1f8ff; border: 1px dashed #69a7ff; border-radius: 8px; padding: .75rem 1rem; margin-top: .75rem; }
