...
@section('title', 'TI-UTM - Editar Subsecciones')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('nombre', $subsection->nombre) }}"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="modulo_id"
                                        ...
                                        @foreach($modulos as $modulo)
                                            <option value="{{ $modulo->id }}" {{ old('modulo_id', $subsection->modulo_id) == $modulo->id ? 'selected' : '' }}>
                                                {{ $modulo->titulo }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="parent_id"
                                        ...
                                        @foreach($subsections as $existingSubsection)
                                            <option value="{{ $existingSubsection->id }}" {{ old('parent_id', $subsection->parent_id) == $existingSubsection->id ? 'selected' : '' }}>
